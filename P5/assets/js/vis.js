   ...
   var showTooltip = function(d) {
    ...
    tooltip
      ...
      .html("College: " + d.Name + "<br />"
      	 + "UnderGraduate Population: " + d["Undergrad Population"] + "<br />"
      	+  "Poverty % : " + d["Poverty Rate"] + "%" + "<br />"
      	+  "% White : "  + d.White + "% \xa0 \xa0" 
      	+  "% Black : "  + d.Black + "% \xa0 \xa0"
      	+  "% Asian : "  + d.Asian + "% \xa0 \xa0"
      	+  "% Hispanic : "  + d.Hispanic + "% \xa0 \xa0"
      	+  "% American Indian : "  + d.American_Indian + "% \xa0 \xa0"
      	+  "% Pacific_Islander : "  + d.Pacific_Islander + "% \xa0 \xa0"
      	+  "% Biracial : "  + d.Biracial + "% \xa0 \xa0")
...
svgbubble.append('g')
  ...
  .append("text")
    ...
    var valuesToShow = [500, 2500, 5000];
	var xCircle = 300;
	var yCircle = 200;
  ...
  svgbubble.append("text")
    .attr("x", xCircle)
    .attr("y",  220)
    .text("Population size of Minority (Non-White)")
    .style("font-size", 10);
  svgbubble.selectAll("legend")
  .data(valuesToShow)
  .enter()
  .append("circle")
    .attr("cx", xCircle)
    .attr("cy", function(d){ return yCircle - d/225 } )
    .attr("r", function(d){ return d/225})
    .style("fill", "none")
    .attr("stroke", "black");
  ...
  .enter()
  .append("line")
    .attr('x1', function(d){ return xCircle + d/225  } )
    .attr('x2', xCircle + 50)
    .attr('y1', function(d){ return yCircle - d/225  } )
    .attr('y2', function(d){ return yCircle - d/225 } )
    .attr('stroke', 'black')
 ...
 svgbubble
  ...
  .append("text")
    .attr('x', xCircle + 50)
    .attr('y', function(d){ return 200 - d/225 } )
